...
sudo /usr/bin/docker run -d --restart="always" --name="sda" -e "tomcat_xmx=2048m" -e "tomcat_xms=512m" -e "tomcat_maxpermsize=256m" -e "container_timezone=America/Chicago" -p 127.0.0.1:8080:8080 -p 127.0.0.1:8009:8009 -m=2048m -v /tomcat/sda/webapps:/usr/local/tomcat/webapps:rw -v /tomcat/sda/logs:/usr/local/tomcat/logs:rw -v /sda:/war-deployment/sda.deploy:rw -t sda-tomcat7
